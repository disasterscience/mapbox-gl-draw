...
Feature.prototype.internal = function(mode) {
  var properties = Object.assign({}, {id: this.id,
    meta: meta.FEATURE,
    'meta:type': this.type,
...
function ui (ctx) {
  ...
  function addButtons() {
    ...
    // @tristan-morris - Adding circle type
    if (controls[types$1.CIRCLE]) {
      buttonElements[types$1.CIRCLE] = createControlButton(types$1.CIRCLE, {
        container: controlGroup,
        className: classes.CONTROL_BUTTON_CIRCLE,
        title: ("Circle tool " + (ctx.options.keybindings ? '(c)' : '')),
        onActivate: function () {
          ctx.events.changeMode(modes$1.DRAW_CIRCLE);
        },
        onDeactivate: function () { return ctx.events.trash(); }
      });
    }
